	...
	<form action="register_submit.php" method="post" id="form_register" enctype="multipart/form-data" >
		...
		<div class="form_2 data_info" id="page_two" style="display: none;">
				<div class="form_container">
							...
							<div class="input_wrap">
								<label for="cv">Curriculum Vitae (.pdf only)</label>
								<input type="file" name="file_cv">
							</div>
							<div class="input_wrap">
								<label for="intent">Letter of Intent (.pdf only) </label>
...
<div class="modal_wrapper">
	...
	<div class="success_wrap">
		...
		<center>
			<input type="submit" class="submit" value="SUBMIT" name="submit_author">
		</center>
	</div>
</div>
</form>
