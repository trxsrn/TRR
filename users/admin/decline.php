...
if (!$result) {
    ...
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        elseif ($row['user_type'] == "REVIEWER") {
            ...
            $insert_query = "INSERT INTO declined_accounts(fullname, birthdate, contact_number, unit, street, barangay, city, province, country, discipline, qualification, designation, affiliation, email_address, username, password, cv, intent, status, id_number, joined_date)
