...
<html>
    ...
    <div class="responsibility-header">
        <div class="editor-responsibilities">
            <div class="editor-header">
                ...
                <div class="responsibilities">
                    <ul>
                        <li>Make Decisions: The editor shall decide whether a work will be published or not. They must consider the research's quality, relevance to the field, and potential impact.</li>

                        <li>Review Manuscripts: The editor is in charge of reviewing submitted manuscripts to make sure that it fits the journal's requirements and follows the submission rules.</li>

                        <li>Quality Check: The editor is responsible for guaranteeing that the published study is of good quality. It includes confirming that the research is appropriately designed, conducted, and reported.</li>

                        <li>Manage Peer Review: The TRR editor is responsible for running the peer review process, which includes choosing readers, making sure reviews are done on time and thoroughly, and making decisions based on what reviewers say.</li>
        ...
        <div class="reviewer-responsibilities">
            ...
            <div class="responsibilities">
                    <ul>
                        <li>Maintain Confidentiality: Any papers submitted for review must be regarded as confidential. They cannot be shown to or discussed with others without the editor's permission.</li>

                        <li>Evaluate Research Design: The reviewer must evaluate the research design, methods, and procedures to ensure they are appropriate and well-executed. They must also assess the data quality and the statistical analyses' suitability.</li>

                        <li>Assess Significance: The reviewer must assess the research's importance and relevance to the field. The reviewer must also carefully weigh the findings' significance and potential implications for future study.</li>

                        <li>Provide Constructive Feedback: Provide detailed and constructive feedback to the authors, highlighting the manuscript's strengths and weaknesses. Suggestions for improvement should be specific, actionable, and aimed at improving the quality of the research.</li>

                        <li>Fairness and Integrity: A reviewer's decision should be based on their thorough and honest assessment of the manuscript to assure the quality and validity of the presented research. By performing their duties as a reviewer with fairness and integrity, they can assist in preserving the high research standards in your field.</li>
                    </ul>
            </div>
        </div>
        <div class="publisher-responsibilities">
            ...
            <div class="responsibilities">
                <ul>
                        <li>Set Editorial Policies and Procedures: The publisher is in charge of setting the journal's editorial policies and procedures, such as the rules for submitting papers, having them reviewed by peers, and getting them published.</li>

                        <li>Editorial Board Management: Publishers manage the editorial board, including hiring members, setting policies, and verifying that they comply with industry standards. It requires working with the board to identify areas for development and developing training programs to improve their skills.</li>

                        <li>Manage the Peer-Review Process: The publisher is responsible for managing the journal's peer-review process. It involves choosing reviewers, keeping track of the review process, and talking to authors and reviewers.</li>

                        <li>Publication Ethics: Publishers are responsible for making sure that all submitted manuscripts follow ethical rules. This includes checking the research to see if it meets ethical standards, making sure that writers have all the permissions and licenses they need, and looking for plagiarism or other types of fraud.</li>

                        <li>Publish Papers: The publisher is in charge of publishing manuscripts in the academic journal. It requires copyediting and proofreading of the papers that will be published.</li>


                        <li>Indexing: The publisher indexes papers from journals, enabling researchers and other readers to locate the manuscripts.</li>
                </ul>
